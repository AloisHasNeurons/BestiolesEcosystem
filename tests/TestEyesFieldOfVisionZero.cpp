...
void run_test_eyes_field_of_vision_zero() {
    std::cout << "Running Test Scenario: Eyes (No Ears) - Field of Vision Zero" << std::endl;
    std::cout << "Observation: Creatures should NOT flock (Gregarious behavior absent) because they cannot see each other." << std::endl;
