...
void run_test_collision_bounce_no_death() {
    std::cout << "Running Test Scenario: Collision Bounce (No Death)" << std::endl;
    std::cout << "Observation: 20 Kamikaze creatures. Bounce off each other. No death (Resistance=1.0)." << std::endl;
