...
void run_test_eyes_detection_range_zero() {
    std::cout << "Running Test Scenario: Eyes (No Ears) - Detection Capability Zero" << std::endl;
    std::cout << "Observation: Creatures should NOT flock because their detection capability (Gamma) is 0." << std::endl;
